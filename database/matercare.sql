...
-- Database: `matercare`
--
CREATE DATABASE IF NOT EXISTS `matercare` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `matercare`;
...
INSERT INTO `appointment` (`appointment_id`, `pregnancy_id`, `doctor_id`, `hospital_id`, `status`, `appointment_date`, `notes`) VALUES
(9, NULL, 1, 1, NULL, '2026-04-13 00:00:00', 'rr'),
(10, NULL, 1, 1, NULL, '2026-04-07 00:00:00', 'efwe');
...
(1, 'Dr. Sharma', 'Gynecologist', '9999999999');
...
--
ALTER TABLE `appointment`
  ADD CONSTRAINT `appointment_ibfk_1` FOREIGN KEY (`pregnancy_id`) REFERENCES `pregnancy_profile` (`pregnancy_id`),
...
--
ALTER TABLE `pregnancy_profile`
  ADD CONSTRAINT `pregnancy_profile_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"matercare\",\"table\":\"appointment\"},{\"db\":\"matercare\",\"table\":\"doctor\"},{\"db\":\"matercare\",\"table\":\"hospital\"}]');
...
('root', '2026-04-04 14:08:21', '{\"Console\\/Mode\":\"collapse\"}');
